...
export function Login() {
  ...
  return (
    <AuthLayout
      title="Welcome back"
      subtitle="Sign in to your Derivo account to continue"
    >
      ...
      <form className="flex flex-col gap-4" onSubmit={handleEmailLogin}>
        <div className="space-y-1">
          <label htmlFor="login-email" className="text-xs font-medium text-white/70 ml-1">Email</label>
          <input
            type="email"
            id="login-email"
            value={email}
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between ml-1">
            ...
            <Link to="/forgot-password" className="text-[11px] text-white/40 hover:text-white transition-colors">
              Forgot password?
            </Link>
          </div>
          <input
