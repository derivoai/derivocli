...
export function Navbar() {
  return (
    <nav className="lightui fixed top-0 left-0 right-0 w-full z-50 bg-background/80 backdrop-blur-2xl border-b border-border">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center space-x-2.5">
          <Logo className="w-7 h-7 text-foreground" />
          <span className="text-xl font-medium tracking-tight text-foreground">Derivo</span>
        </Link>
